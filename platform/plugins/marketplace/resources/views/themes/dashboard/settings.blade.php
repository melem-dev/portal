                    ...
                    <div class="tab-content card-body border border-top-0">
                        <div class="tab-pane active" id="tab_information">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="shop-name" class="required">{{ __('Razão social') }}</label>
                                        <input class="form-control" name="name_business" id="shop-name" type="text" value="{{ old('name_business', $store->name_business) }}" placeholder="{{ __('Razão Social') }}">
                                        @if ($errors->has('name_business'))
                                            <span class="text-danger">{{ $errors->first('name_business') }}</span>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="shop-phone" class="required">{{ __('CNPJ') }}</label>
                                        <input class="form-control" name="ein" id="shop-phone" type="text" value="{{ old('ein', $store->ein) }}" placeholder="{{ __('CNPJ') }}">
                                        @if ($errors->has('ein'))
                                            <span class="text-danger">{{ $errors->first('ein') }}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
