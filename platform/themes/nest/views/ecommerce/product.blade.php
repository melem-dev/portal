        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
            <div class="detail-info pr-30 pl-30">
                ...
                <div class="clearfix product-price-cover">
                    <div class="product-price primary-color float-left" style="display: block !important;">
                        <span>
                            <span class="save-price font-md color3" @if ($product->front_sale_price == $product->price) style="display: none" @endif>
                                <span class="percentage-off">{{ str_replace('-', '', get_sale_percentage($product->price, $product->front_sale_price)) }} {{ __('Off') }}</span>
                            </span>
                            <span class="old-price font-md" style="font-size: 20px; padding-bottom: 10px; margin-left: 0px !important;  @if ($product->front_sale_price == $product->price) display: none @endif">{{ format_price($product->price_with_taxes) }}</span>
                        </span>
                ...
                <form class="add-to-cart-form" method="POST" action="{{ route('public.cart.add-to-cart') }}">
                    ...
                    <div class="detail-extralink mb-50">
                        <div class="product-extra-link2 has-buy-now-button">
                            @if($product->sku)
                                <button type="button" class="button btn-quero" onclick="window.open('{{ $product->sku }}','_blank');">
                                    EU QUERO
                                </button>
                            @endif
                        </div>
...
{{--                        @endif--}}
    ...
    <div class="row mt-60" id="related-products">
        <div class="col-12">
            <h3 class="section-title style-1 mb-30">Promoções relacionadas</h3>
        </div>
