                ...
                @else
                    ...
                    @else
                        @if ($product->front_sale_price !== $product->price)
                            <span class="hot">{{ str_replace('-', '', get_sale_percentage($product->price, $product->front_sale_price)) }}</span>
                        @endif
                    @endif
                @endif
            </div>
            ...
            <div class="product-card-bottom">
                ...
                <div class="add-cart">
                    <a
                        ...
                        href="#" class="action-btn hover-up js-quick-view-button add" data-url="{{ route('public.ajax.quick-view', $product->id) }}">
                        <i class="fi-rs-eye"></i>
                    </a>
                </div>
            </div>
