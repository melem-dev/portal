...
$(function() {
  ...
  if(bgndKenburns3.length){
    bgndKenburns3.vegas({
      ...
      transitionDuration: 2000,
      slides: [
        { src: "img/backgrounds/1366x768-bg-kenburns-3_1.jpg" },
        { src: "img/backgrounds/1366x768-bg-kenburns-3_2.jpg" },
        { src: "img/backgrounds/1366x768-bg-kenburns-3_3.jpg" }
      ],
      animation: [ 'kenburnsUp', 'kenburnsDown', 'kenburnsLeft', 'kenburnsRight' ]
    });
  };
  ...
  if(bgndKenburns4.length){
    bgndKenburns4.vegas({
      ...
      transitionDuration: 2000,
      slides: [
        { src: "img/backgrounds/1366x768-bg-kenburns-4_1.jpg" },
        { src: "img/backgrounds/1366x768-bg-kenburns-4_2.jpg" },
        { src: "img/backgrounds/1366x768-bg-kenburns-4_3.jpg" }
      ],
      animation: [ 'kenburnsUp', 'kenburnsDown', 'kenburnsLeft', 'kenburnsRight' ]
    });
  };
  ...
  if(bgndKenburns5.length){
    bgndKenburns5.vegas({
      ...
      transitionDuration: 2000,
      slides: [
        { src: "img/backgrounds/1366x768-bg-kenburns-5_1.jpg" },
        { src: "img/backgrounds/1366x768-bg-kenburns-5_2.jpg" },
        { src: "img/backgrounds/1366x768-bg-kenburns-5_3.jpg" }
      ],
      animation: [ 'kenburnsUp', 'kenburnsDown', 'kenburnsLeft', 'kenburnsRight' ]
    });
  };

  var bgndKenburns6 = $('#bgndKenburns-color-6');
  if(bgndKenburns6.length){
    bgndKenburns6.vegas({
      timer: false,
      delay: 10000,
      transition: 'fade2',
      transitionDuration: 2000,
      slides: [
        { src: "img/backgrounds/1366x768-bg-kenburns-6_1.jpg" },
        { src: "img/backgrounds/1366x768-bg-kenburns-6_2.jpg" },
        { src: "img/backgrounds/1366x768-bg-kenburns-6_3.jpg" }
      ],
      animation: [ 'kenburnsUp', 'kenburnsDown', 'kenburnsLeft', 'kenburnsRight' ]
    });
  };

  var bgndKenburns7 = $('#bgndKenburns-color-7');
  if(bgndKenburns7.length){
    bgndKenburns7.vegas({
      timer: false,
      delay: 10000,
      transition: 'fade2',
      transitionDuration: 2000,
      slides: [
        { src: "img/backgrounds/1366x768-bg-kenburns-7_1.jpg" },
        { src: "img/backgrounds/1366x768-bg-kenburns-7_2.jpg" },
        { src: "img/backgrounds/1366x768-bg-kenburns-7_3.jpg" }
      ],
      animation: [ 'kenburnsUp', 'kenburnsDown', 'kenburnsLeft', 'kenburnsRight' ]
    });
  };
  ...
  // KBW-Countdown Start
  // --------------------------------------------- //
  $('#countdown').countdown({until: $.countdown.UTCDate(+12, 2021, 13, 15), format: 'D'});
  $('#countdown-large').countdown({until: $.countdown.UTCDate(+10, 2021, 11, 15), format: 'DHMS'});
  // --------------------------------------------- //
  // KBW-Countdown End
  // --------------------------------------------- //
